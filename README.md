...
- Relational databases store their data in tables. SQL,(Structured Query Language), is one of the standard languages used to manage databases and helps to interact with data in them.
...
- [ ]  when multiple records in a table are refering to  multiple records in another table.
